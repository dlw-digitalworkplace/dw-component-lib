...
## Disable
Use the `disable` property to disable the drag event.
The `isDragging` will still be set, but the element will not move.
<Canvas withToolbar={true}>
	<Story story={stories.Disable} name="Disable" />
</Canvas>
