...
The `PeoplePicker` controls allows you to select users and groups.
This control is basically a rework of the [Fluient UI](https://developer.microsoft.com/en-us/fluentui#/controls/web/peoplepicker) people picker without the dependency on the Persona object.
